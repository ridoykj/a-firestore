...
- Name: firestore-page.spec.ts >> Firestore Page >> should show bulk delete option when rows are selected
- Location: e2e\firestore-page.spec.ts:31:3
...
Locator: getByRole('button', { name: /More actions/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /More actions/i })
