...
- Name: firestore-page.spec.ts >> Firestore Page >> mobile layout should use sheet component
- Location: e2e\firestore-page.spec.ts:40:3
...
Locator: locator('[class*="fixed"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[class*="fixed"]').first()
