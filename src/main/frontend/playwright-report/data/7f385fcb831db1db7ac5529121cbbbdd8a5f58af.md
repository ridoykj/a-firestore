...
- Name: firestore-page.spec.ts >> Firestore Page >> should have run query button
- Location: e2e\firestore-page.spec.ts:25:3
...
Locator: getByRole('button', { name: /Run Query/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /Run Query/i })
