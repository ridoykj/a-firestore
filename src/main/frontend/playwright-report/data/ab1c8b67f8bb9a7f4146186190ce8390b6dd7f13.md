...
- Name: firestore-page.spec.ts >> Firestore Page >> should have collection path input
- Location: e2e\firestore-page.spec.ts:19:3
...
Locator: getByPlaceholder(/users|posts/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByPlaceholder(/users|posts/i)
