...
- `src/main/resources/static/` is build output regenerated by every Maven build; `index.html` is
  tracked despite the ignore rules, so it routinely shows as modified — don't hand-edit it.
